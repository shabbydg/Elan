...
public class CaldroidGridAdapter extends BaseAdapter {
	...
	public CaldroidGridAdapter(Context context, int month, int year,
		...
		//customize font -> Set Arabic
		String fontPath = "fonts/alfatemi152.ttf";
	 ...
	 * @param cellView
	 */
	protected void customizeTextView(int position, TextView cellView , TextView cellView2, RelativeLayout cell_layout) {
		...
		if (shouldResetDiabledView && shouldResetSelectedView) {
			// Customize for today
			if (dateTime.equals(getToday())) {
				cell_layout.setBackgroundResource(R.drawable.selected_date_bg);
			} else {
		...
		cellView2.setTextColor(resources
				.getColor(R.color.caldroid_light_yellow));
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		RelativeLayout cell_layout = (RelativeLayout) cellView.findViewById(R.id.cell_layout);
